...
products_data = [
  ...
  { name: 'アメジストドゥルージー',
    price: 2480,
    description: 'ウルグアイ産アメジストのドゥルージーペンダントトップです。 「ドゥルージー」とは小さな結晶が表れた部分のことをいいます。 原石の結晶がキラキラと輝き、天然石の魅力を堪能できるお品です。 画像のお品が現物です。',
  ...
  { name: 'ルビーインフックサイト',
    price: 2480,
    description: 'アフリカ産ルビーインフックサイトのペンダントトップです。 フックサイトと呼ばれるマイカ（レピドライトなど）グループの鉱物の仲間で、落ち着いたブルーグリーンのベースにルビーの深みのあるレッドが混ざります。',
